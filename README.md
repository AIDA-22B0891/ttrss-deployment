...
- id: SERIAL, Автоинкрементный первичный ключ. Технический уникальный идентификатор записи в рамках нашей аналитической базы. Значение генерируется автоматически при вставке новой строки и гарантирует целостность и порядок записей. PRIMARY KEY
